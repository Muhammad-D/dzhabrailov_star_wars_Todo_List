export const TOGGLE_TASK = "main-reducer/TOGGLE_TASK";
export const DELETE_TASK = "main-reducer/DELETE_TASK";
export const ADD_TASK = "main-reducer/ADD_TASK";
export const GET_STATE = "main-reducer/GET_STATE";
